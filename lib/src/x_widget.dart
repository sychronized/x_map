...
class _AMapOptions {
  ...
  ///步行规划 此处传入的是两个点的坐标拼接字符串 空字符串代表清空数据
  final String? walkRoute;
  ...
  static _AMapOptions fromWidget(AMapWidget map) {
    return _AMapOptions(
      ...
      tileEnabled: map.tileEnabled,
      walkRoute: map.walkRoute,
  ...
  Map<String, dynamic> toMap() {
    ...
    addIfNonNull('tileEnabled', tileEnabled);
    addIfNonNull('walkRoute', walkRoute);
    addIfNonNull('areaLevel', arealevel);
    addIfNonNull('areaCode', areaCode);
