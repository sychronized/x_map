...
class AMapController {
  ...
  /// 用户是否在责任区
  Future<bool?> isInDuty(double lat, double lng) {
    return _methodChannel.isInDuty(mapId: mapId, lat: lat, lng: lng);
  }

  /// 开始轨迹动画
  Future<void> startLocusAnimation() {
    return _methodChannel.startLocusAnimation(mapId: mapId);
  }
}
