...
import 'package:x_map/src/types/base_overlay.dart';
...
class Marker extends BaseOverlay {
  ...
  /// 显示跳动动画
  final bool showUpDown;

  /// 显示涟漪动画
  final bool showRippling;
  ...
  Marker copyWith({
    ...
    bool? visibleParam,
    bool? showUpDownParam,
    bool? showRipplingParam,
    ...
    Marker copyMark = Marker(
      ...
      showUpDown: showUpDownParam ?? showUpDown,
      showRippling: showRipplingParam ?? showRippling,
    );
  ...
  Map<String, dynamic> toMap() {
    ...
    addIfPresent('showUpDown', showUpDown);
    addIfPresent('showRippling', showRippling);
    return json;
  }
  ...
  bool operator ==(Object other) {
    ...
    return id == typedOther.id &&
        ...
        showUpDown == typedOther.showUpDown &&
        showRippling == typedOther.showRippling;
  }
  ...
  String toString() {
    return 'Marker{id: $id, alpha: $alpha, anchor: $anchor, '
        ...
        'visible: $visible, zIndex: $zIndex, showUpDown: $showUpDown, showRippling: $showRippling, onTap: $onTap}';
  }
}
