...
public class Const {
    ...
    public static final String METHOD_POLYGON_IS_IN_DUTY = "map#isInDuty";
    public static final String[] METHOD_ID_LIST_FOR_POLYGON = {METHOD_POLYGON_UPDATE, METHOD_POLYGON_IS_IN_DUTY};
    ...
    public static final String METHOD_POLYLINE_LOCUS_ANIMATION = "polylines#locusAnimation";
    public static final String[] METHOD_ID_LIST_FOR_POLYLINE = {METHOD_POLYLINE_UPDATE, METHOD_POLYLINE_LOCUS_ANIMATION};
}
