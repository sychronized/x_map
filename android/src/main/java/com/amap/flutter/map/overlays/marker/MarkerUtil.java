...
public class MarkerUtil {
    ...
    public static String interpretMarkerOptions(Object o, MarkerOptionsSink sink) {
        ...
        final Object showUpDown = data.get("showUpDown");
        if (showUpDown != null) {
            sink.setShowUpDown(ConvertUtil.toBoolean(showUpDown));
        }
        final Object showRippling = data.get("showRippling");
        if (showRippling != null) {
            Log.e("xxx", "xxx showRippling: " + showRippling);
            sink.setShowRippling(ConvertUtil.toBoolean(showRippling));
        }
