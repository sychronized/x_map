...
class AMapOptionsBuilder implements AMapOptionsSink {
    ...
    AMapPlatformView build(int id,
        ...
        try {
            ...
            aMapPlatformView.getMapController().setWalkRoute(walkRoute);
            aMapPlatformView.getMapController().setAreaLevel(areaLevel);
            aMapPlatformView.getMapController().setAreaCode(areaCode);
            aMapPlatformView.getMapController().setTileEnabled(tileEnabled);
