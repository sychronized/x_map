...
public class AMapPlatformView
    ...
    private void initCustomInfoWindow(AMap amap){
        amap.setInfoWindowAdapter(new AMap.InfoWindowAdapter() {
            @Override
            public View getInfoWindow(Marker marker) {
                if(marker.getTitle().contains("您当前在责任区")){
                    View infoWindow = View.inflate(mContext,
                            R.layout.my_infowindow_view, null);
                    ((TextView)infoWindow.findViewById(R.id.infoWindowTv)).setText(marker.getTitle());
                    if(marker.getTitle().endsWith("外")){
                        ((ImageView)infoWindow.findViewById(R.id.infoWindowIv)).setImageResource(R.drawable.ic_duty_out);
                    }else {
                        ((ImageView)infoWindow.findViewById(R.id.infoWindowIv)).setImageResource(R.drawable.ic_duty_in);
                    }
                    return infoWindow;
                }else if(marker.getTitle().contains("未绑定")) {
                    View infoWindow = View.inflate(mContext,
                            R.layout.my_infowindow_view, null);
                    ((TextView)infoWindow.findViewById(R.id.infoWindowTv)).setText(marker.getTitle());
                    ((ImageView)infoWindow.findViewById(R.id.infoWindowIv)).setImageResource(R.drawable.ic_duty_out);
