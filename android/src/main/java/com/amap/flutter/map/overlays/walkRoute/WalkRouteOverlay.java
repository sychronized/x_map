package com.amap.flutter.map.overlays.walkRoute;
...
import com.amap.flutter.map.utils.AMapServicesUtil;
...
//        }
		...
		mPolylineOptions.setCustomTexture(BitmapDescriptorFactory.fromResource(R.drawable.road_green_arrow)) //setCustomTextureList(bitmapDescriptors)
				.useGradient(true)
				.width(getRouteWidth());
	}
